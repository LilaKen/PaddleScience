...
from ppsci.arch.transolver import Transolver_block_Irregular_Mesh_Elas, Transolver_block_Mesh_2D, Transolver_block_Mesh_3D, Transolver_Irregular_Mesh_Elas  # isort:skip
